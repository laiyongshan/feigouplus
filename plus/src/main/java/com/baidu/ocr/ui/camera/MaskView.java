...
public class MaskView extends View {
    ...
    public static final int MASK_TYPE_VEHICLE_LICENSE = 21;

    @IntDef({MASK_TYPE_NONE, MASK_TYPE_ID_CARD_FRONT, MASK_TYPE_ID_CARD_BACK, MASK_TYPE_BANK_CARD, MASK_TYPE_VEHICLE_LICENSE})
    @interface MaskType {
    ...
    public void setMaskType(@MaskType int maskType) {
        ...
        switch (maskType) {
            ...
            case MASK_TYPE_ID_CARD_BACK:
                ...
                break;
            case MASK_TYPE_VEHICLE_LICENSE:
                locatorDrawable = ResourcesCompat.getDrawable(getResources(), R.drawable.bd_ocr_vehicle_license, null);
                break;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        }else if (maskType==MASK_TYPE_VEHICLE_LICENSE){
            locatorDrawable.setBounds(
                    (int) (left + 50f / 1006 * width),
                    (int) (top + (390f / 632) * height),
                    (int) (left + (280f / 1006) * width),
                    (int) (top + (620f / 632) * height));
        }
