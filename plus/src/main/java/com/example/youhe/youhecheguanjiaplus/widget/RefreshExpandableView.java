 ...
 * 上拉刷新
 */
public class RefreshExpandableView extends SwipeRefreshLayout {
    ...
    public RefreshExpandableView(Context context) {
        super(context);
        initListView(null);
    }

    public RefreshExpandableView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initListView(attrs);
        init();
    }
    ...
    private void initListView(AttributeSet attrs) {
        ...
        if (attrs != null)
            listView = new ExpandableListView(getContext(), attrs);
        else
    ...
    public void setOnGroupClickListener(ExpandableListView.OnGroupClickListener o){
        listView.setOnGroupClickListener(o);
    }

    public void setOnChildClickListener(ExpandableListView.OnChildClickListener o){
        listView.setOnChildClickListener(o);
    }
